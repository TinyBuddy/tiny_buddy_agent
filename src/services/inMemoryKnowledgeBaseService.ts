		...
		return [
			{
				...
				content:
					"1像铅笔细又长，2像鸭子水中游，3像耳朵听声音，4像小旗随风飘，5像秤钩来买菜，6像哨子嘟嘟叫，7像镰刀割青草，8像麻花拧一道，9像勺子来吃饭，10像铅笔加鸡蛋。",
				language: "zh",
				difficulty: "easy",
				categories: ["数学", "数字", "基础"],
			...
			},
			{
				...
				content:
					"小兔子乖乖，把门开开，快点开开，我要进来。不开不开我不开，妈妈没回来，谁来也不开。小兔子乖乖，把门开开，快点开开，我要进来。就开就开我就开，妈妈回来了，我就把门开。",
				language: "zh",
				difficulty: "easy",
				categories: ["童话", "安全", "经典"],
				createdAt: new Date("2024-01-01"),
